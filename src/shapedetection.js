        ...
        this.detect = function(canvas) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                qr.callback = function(result, err) {
                  ...
                  x = Math.min.apply(null, pts.map(function(p) { return p.x }));
                  y = Math.min.apply(null, pts.map(function(p) { return p.y }));
                  width = Math.max.apply(null, pts.map(function(p) { return p.x })) - x;
                  height = Math.max.apply(null, pts.map(function(p) { return p.y })) - y;
                  // for the moment, fake the ability to detect multiple entities
                  proc_result = [{
